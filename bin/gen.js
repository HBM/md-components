...
export function Button (props) {
  return <button type='button' className='IconButton' {...props}>
    {props.children}
  </button>
}
`,
...
export function Logo (props) {
  return <svg width='68' height='61' viewBox='0 0 68 61' style={{maxWidth: '100%', maxHeight: '100%'}}>
...
`
  ...
  // save array to file
  let fileContent = all.join('')
  fileContent = `import React from 'react'\n${fileContent}`
  fs.writeFileSync(path.join(__dirname, '..', 'components', 'icon', 'index.js'), fileContent)
}
